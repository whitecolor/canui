steal('jquery',
	 ...
	 *		});
		 ...
		 */
		return can.Control.extend("can.ui.Positionable",
			{
			 ...
			 */
			{
				...
				position : function(el, ev, positionFrom){
					...
					//slog('basePosition', basePosition )
					...
					//slog('elemWidth elemHeight', elemWidth, elemHeight )
					...
					//slog('position before', position.top, elemHeight, options.my )
